...
export default function Photobooth() {
  ...
  const [phase, setPhase]         = useState("preview")   // "preview" | "confirm" | "saving" | "saved"
  const [screenshot, setScreenshot] = useState(null)      // base64 snapshot
      ...
      <div style={{ maxWidth: 700, margin: "40px auto", padding: "0 24px" }}>
        ...
        {phase === "preview" && (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 24 }}>
            ...
            <p className="font-dm" style={{ color: "rgba(255,255,255,0.55)", fontSize: 13 }}>
              A 3-second countdown will start before the shot is taken
            </p>
          </div>
        )}

        {/* ════════════════════════════════════════
            PHASE: confirm — review + add details
        ════════════════════════════════════════ */}
            ...
            <div style={{ display: "flex", gap: 24, alignItems: "flex-start", flexWrap: "wrap" }}>
              ...
              <div style={{ flex: 1, minWidth: 200, display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    {["", "retro", "festive", "minimal", "dreamy"].map((style) => (
                      <button
                        ...
                        style={{
                          ...
                          cursor: "pointer",
                          fontWeight: frameStyle === style ? 600 : 400,
                          transition: "all 0.2s",
                        }}
                      >
                ...
                <div style={{ display: "flex", gap: 10, marginTop: 8 }}>
                  <button className="btn-secondary" onClick={handleRetake} style={{ flex: 1 }}>
                    Retake
                  </button>
        ...
        {phase === "saving" && (
          <div className="glass-card" style={{ padding: 60, textAlign: "center" }}>
            ...
            <h3 className="font-playfair" style={{ fontSize: 22, color: "var(--text)" }}>
              Saving your memory...
            </h3>
          </div>
        )}
        ...
        {/* ════════════════════════════════════════
            PHASE: saved — success screen
        ════════════════════════════════════════ */}
        {phase === "saved" && (
          <div className="glass-card" style={{ padding: 48, textAlign: "center" }}>
            <div style={{ fontSize: 56, marginBottom: 16 }} className="float">🎉</div>
            <h3 className="font-playfair" style={{ fontSize: 26, color: "var(--text)", marginBottom: 8 }}>
              Photo saved!
            </h3>
